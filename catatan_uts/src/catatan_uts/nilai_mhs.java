...
public class nilai_mhs extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int uts     = Integer.parseInt(jTextField1.getText());
        int uas     = Integer.parseInt(jTextField2.getText());
        int tugas     = Integer.parseInt(jTextField3.getText());
        
        double total    = (uts+uas+tugas)/3;
        if(total > 100) {
            jLabel5.setText("Nilai Terlalu Tinggi");
        } else if(tugas>55 && total >= 80) {
            jLabel5.setText("A");
        } else if(tugas>55 && total >= 70) {
            jLabel5.setText("B");
        } else if(tugas<=55 && total >= 70) {
            jLabel5.setText("C");
        } else if(total >= 50) {
